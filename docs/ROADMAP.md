...
- [~] Release 1E — RH básico (pessoa, status de vínculo, férias/ausências, desligamento revoga sessão) ✅ · apontamento e produtividade (cronômetro, folha semanal, estimado × realizado) ✅ · cargos/vagas/candidatos/eNPS pendentes · Home executiva (seção 6.1) pendente, ver `docs/DECISIONS.md` de 2026-09-05 · financeiro manual (seção 22) pendente
