...
- [~] Release 1D — Conteúdo (planejamento, versões, calendário, filtro por cliente, fila de aprovação, comentários) ✅ · aprovação por link público ✅ · biblioteca pendente (depende de storage) · portal do cliente com login pendente · comunicação/menções genéricas pendente
