...
- [~] Release 1E — RH básico (pessoa, status de vínculo, férias/ausências, desligamento revoga sessão) ✅ · cargos/vagas/candidatos/eNPS pendentes · apontamento de horas e produtividade (seção 21) pendente · Home executiva (seção 6.1) pendente, ver `docs/DECISIONS.md` de 2026-09-05 · financeiro manual (seção 22) pendente
