...
- [~] Release 1E — RH básico (pessoa, status de vínculo, férias/ausências, desligamento revoga sessão) ✅ · apontamento e produtividade (cronômetro, folha semanal, estimado × realizado) ✅ · Home executiva v1 (seção 6.1) ✅ · cargos/vagas/candidatos/eNPS pendentes · Home v2 (KPIs financeiros/Health Score) pendente · financeiro manual (seção 22) pendente
