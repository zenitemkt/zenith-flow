...
- [~] Fase 2 — **Health Score (seção 30) ✅** (3 de 7 dimensões com dado real: Financeiro/Entregas/Aprovações, renormalizadas; score neutro quando falta dado) · **Risco de churn e playbook de retenção (seção 31) ✅** (3 de 6 sinais aditivos com dado real; plano de recuperação não soma, só sinaliza) · régua de cobrança (seção 28), indicadores financeiros/MRR (seção 29), NPS/eNPS/cohort/reativação (seção 32) e Asaas (seção 27, precisa de conta sandbox nova do usuário) pendentes
